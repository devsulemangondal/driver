...
class _MercadoPagoScreenState extends State<MercadoPagoScreen> {
  ...
  void initController() {
    try {
          ...
          NavigationDelegate(
            ...
            onNavigationRequest: (NavigationRequest navigation) async {
              try {
                ...
                if (navigation.url.contains("${Constant.paymentCallbackURL}/failure") ||
                    navigation.url.contains("${Constant.paymentCallbackURL}/pending")) {
      ...
      developer.log(
        "Error initializing WebViewController",
        error: e,
        stackTrace: stack,
      );
